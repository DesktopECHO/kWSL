...
%GO% "rm -f /etc/xrdp/cert.pem /etc/xrdp/key.pem ; cp /etc/ssl/certs/ssl-cert-snakeoil.pem  /etc/xrdp/cert.pem ; cp /etc/ssl/private/ssl-cert-snakeoil.key /etc/xrdp/key.pem ; chmod 640 /etc/xrdp/rsakeys.ini ; chown root:xrdp /etc/xrdp/rsakeys.ini ; chown xrdp:root /etc/xrdp/key.pem ; chmod 440 /etc/xrdp/key.pem ; sed -i 's/port=3389/port=%RDPPRT%/g' /tmp/kWSL/dist/etc/xrdp/xrdp.ini"
