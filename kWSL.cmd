...
%GO% "sed -i 's/Icon=org.gnome.Nautilus/Icon=system-file-manager/g' /usr/share/applications/org.gnome.Nautilus.desktop"
...
START /MIN /WAIT "Updates for WSL1 Compatibility" "%DISTROFULL%\LxRunOffline.exe" "r" "-n" "%DISTRO%" "-c" "dpkg -i /tmp/kWSL/deb/libkf5activitiesstats1_*.deb /tmp/kWSL/deb/kactivitymanagerd*.deb /tmp/kWSL/deb/kinfocenter*.deb /tmp/kWSL/deb/systemsettings*.deb"
