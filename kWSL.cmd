...
%GO% "printf '#!/bin/bash' > /usr/local/bin/plasma-discover ; printf '\nsudo systemctl start dbus\n/usr/libexec/packagekitd --disable-timer\nkdesu -n --noignorebutton -d -- bash -c +source /etc/profile.d/kWSL.sh ; /usr/bin/plasma-discover --backends packagekit-backend,kns-backend\nsudo systemctl stop dbus\n' >> /usr/local/bin/plasma-discover ; chmod +x /usr/local/bin/plasma-discover"
%GO% "printf '#!/bin/bash' > /usr/local/bin/muon ; printf '\nsudo systemctl start dbus\n/usr/libexec/packagekitd --disable-timer\nkdesu -n --noignorebutton -d -- bash -c +source /etc/profile.d/kWSL.sh ; /usr/bin/muon\nsudo systemctl stop dbus\n' >> /usr/local/bin/muon ; chmod +x /usr/local/bin/muon"
