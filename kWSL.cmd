...
%GO% "echo %DNS% > /etc/resolv.conf ; DEBIAN_FRONTEND=noninteractive apt-fast -qqy install /tmp/kWSL/deb-kde/*.deb plasma-desktop plasma-workspace kwin-x11 systemsettings qt6-gtk-platformtheme konsole breeze-gtk-theme kde-config-gtk-style plasma-desktoptheme plasma-integration plasma-pa webext-plasma-browser-integration falkon --no-install-recommends" > ".\logs\%TIME:~0,2%%TIME:~3,2%%TIME:~6,2% K Desktop Environment.log" 2>&1 
