...
ECHO:
%GO% "sudo -u zero bash -c 'xdg-mime default nemo.desktop inode/directory application/x-gnome-saved-search ; gsettings set org.gnome.desktop.background show-desktop-icons false ; gsettings set org.nemo.desktop show-desktop-icons false'"
